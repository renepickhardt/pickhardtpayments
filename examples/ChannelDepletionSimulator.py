...
with open("payments_first_one_ok.json") as jsonFile:
...
for payment in payment_set:
    ...
    maximum_payable_amount = oracle_lightning_network.theoretical_maximum_payable_amount(payment['_sender'],
                                                                                         payment['_receiver'], 1000)
    logging.info("%s sats would be possible on this oracle to deliver if including 1 sat base fee channels",
