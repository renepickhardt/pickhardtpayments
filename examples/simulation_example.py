...
payment_session.pickhardt_pay(RENE, C_OTTO, 8_000_000, mu=0, base=0, loglevel="debug")
# payment_session.pickhardt_pay("A", "D", 10000, mu=0, base=0, loglevel="debug")
# payment_session.forget_information()
payment_session.pickhardt_pay(RENE, C_OTTO, 4_000_000, mu=0, base=0, loglevel="debug")
